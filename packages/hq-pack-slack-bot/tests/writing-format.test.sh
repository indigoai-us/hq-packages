...
require "Progressive delivery"
require "FIRST post one short kickoff beat in-thread"
require "at most one short beat per major"
require "narrating tool calls"
require "The final answer is its OWN separate message"
require "NEVER glue planning"
require "never re-narrate past"
require "same thread"
